            ...
            <form action="{{ route('admin.membres.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="designation" id="designation" class="form-control"
                        value="{{ old('designation') }}" placeholder="Ex: Directeur Général">
                    @error('designation')
                        <span style="color: #ef4444; font-size: 13px;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="fb_link" id="fb_link" class="form-control" value="{{ old('fb_link') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="tw_link" id="tw_link" class="form-control" value="{{ old('tw_link') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="ig_link" id="ig_link" class="form-control" value="{{ old('ig_link') }}"
                        placeholder="https://www.instagram.com/clskycompany/">
                    @error('ig_link')
                        <span style="color: #ef4444; font-size: 13px;">{{ $message }}</span>
                    @enderror
                </div>
