...
@section('content')
    ...
    <section class="page-header"
        style="background: linear-gradient(90deg, #2c3e50 0%, #34495e 100%); padding: 60px 0; text-align: center; color: white;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            ...
            <div
                ...
                <span style="display: flex; align-items: center; gap: 8px;">
                    <i class="fas fa-calendar" style="color: #var(--main-bg-color);"></i>
    ...
    <section style="padding: 60px 0; background: #f8f9fa;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            <div style="max-width: 900px; margin: 0 auto;">
                ...
                <!-- Article Card -->
                <div
                    style="background: white; border-radius: 10px; overflow: hidden; box-shadow: 0 3px 10px rgba(0,0,0,0.1); margin-bottom: 40px;">

                    <!-- Featured Image -->
                    @if ($annonce->image)
                        <div style="width: 100%; height: 450px; overflow: hidden;">
                            <img src="{{ asset('storage/' . $annonce->image) }}" alt="{{ $annonce->title }}"
                                style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    @else
                        <div
                            style="width: 100%; height: 450px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center;">
                    ...
                    <div style="padding: 40px;">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 8px; color: #7f8c8d;">
                                <i class="fas fa-clock" style="color: #var(--main-bg-color);"></i>
                        ...
                        <div style="margin-top: 40px; padding-top: 30px; border-top: 2px solid #e0e0e0;">
                            ...
                            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                                ...
                                <a href="https://wa.me/?text={{ $annonce->title }} {{ url()->current() }}" target="_blank"
                        ...
                        <div class="news-card">
                            @if ($autre->image)
                                <div class="news-image"
                                    style="background: url('{{ asset('storage/' . $autre->image) }}') center/cover; height: 250px; position: relative;">
                                    <div class="news-date">
                            ...
                            @else
                                <div class="news-image"
                                    style="background: {{ $gradient }}; height: 250px; position: relative;">
                                    <div class="news-date">
                                        <span class="day">{{ $autre->created_at->format('d') }}</span>
                                        <span class="month">{{ $autre->created_at->format('M') }}</span>
                                    </div>
    ...
    {{-- <section
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            ...
            <p
                style="font-size: 16px; margin-bottom: 30px; max-width: 600px; margin-left: auto; margin-right: auto; line-height: 1.6; color: #95a5a6;">
            ...
            <form onsubmit="handleNewsletter(event)"
                style="max-width: 500px; margin: 0 auto; display: flex; gap: 10px; flex-wrap: wrap;">
                <input type="email" placeholder="Votre adresse email" required
                    style="flex: 1; min-width: 250px; padding: 15px 20px; border-radius: 5px; border: none; font-size: 15px;">
                <button type="submit" class="btn btn-primary" style="padding: 15px 30px; white-space: nowrap;">
